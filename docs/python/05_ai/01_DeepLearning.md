...
> 知识体系是学习的骨架 — 先见森林，再见树木，具体思维导图参见：[深度学习知识体系](https://app.xmind.cn/XRnpR3Cm?utm_source=xmind_cn)

<p align='center'>
	<img src='../../assets/imgs/python/pytorch/pytorch08_整体思维导图.png'>
</p>
...
<p align='center'style='zoom:80%'>
	<img src='../../assets/imgs/python/pytorch/深度学习概述.png'>
</p>

!!! info "深度学习 vs 传统机器学习"
    深度学习能够**自动提取特征**，适合处理**非结构化数据**（图像、音频、文本等），而传统机器学习通常需要人工特征工程。
<p align='center' >
	<img src='../../assets/imgs/python/pytorch/深度学习与机器学习的对比.png'>
</p>
...
<p align='center' >
	<img src='../../assets/imgs/python/pytorch/神经网络的构成.png'>
</p>
...
<p align='center' >
	<img src='../../assets/imgs/python/pytorch/激活函数.png'>
</p>
...
PyTorch = 带 GPU 加速和自动求导的 NumPy + 神经网络工具箱

具体多的两件事，恰好是深度学习最需要的：

- 张量能跑 GPU（`.to('cuda')` 一句话搬过去）
- 张量能自动求梯度（`requires_grad=True` + `.backward()`）
...
<p align='center'>
	<img src='../../assets/imgs/python/pytorch/常见激活函数.png'>
</p>
...
<p align='center'>
	<img src='../../assets/imgs/python/pytorch/反向传播算法.png'>
</p>
...
<p align='center'>
	<img src='../../assets/imgs/python/pytorch/训练阶段的三个过程.png'>
</p>
